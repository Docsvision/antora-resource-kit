...
+
* `C:\Program Files\Docsvision\Platform\Tools\Database\ApprovalDesigner\ApprovalDesignerCardLib.xml`.
* `C:\Program Files\Docsvision\Platform\Tools\Database\BackOffice\BackOfficeCardLib.xml`.
* `C:\Program Files\Docsvision\Platform\Tools\Database\Core\SystemCardLib.xml`.
* `C:\Program Files\Docsvision\Platform\Tools\Database\DocumentManagement\DocumentManagementCardLib.xml`.
* `C:\Program Files\Docsvision\Platform\Tools\Database\TakeOffice\TakeOfficeCardLib.xml`.
* `C:\Program Files\Docsvision\Platform\Tools\Database\WindowsClient\WindowsClientCardLib.xml`.
* `C:\Program Files\Docsvision\Platform\Tools\Database\Workflow\WorkflowCardLib.xml`.
* `C:\Program Files\Docsvision\Platform\Tools\Database\WorkerService\WorkerServiceCardLib.xml`.
+
Здесь `C:\Program Files\Docsvision\Platform\` -- каталог установки сервера {dv}.
+
