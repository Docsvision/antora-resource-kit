...
+
.Расположение библиотек карточек в Windows:
****
* `C:\Program Files\Docsvision\Database\ApprovalDesigner\ApprovalDesignerCardLib.xml`.
* `C:\Program Files\Docsvision\Database\BackOffice\BackOfficeCardLib.xml`.
* `C:\Program Files\Docsvision\Database\Core\SystemCardLib.xml`.
* `C:\Program Files\Docsvision\Database\DocumentManagement\DocumentManagementCardLib.xml`.
* `C:\Program Files\Docsvision\Database\TakeOffice\TakeOfficeCardLib.xml`.
* `C:\Program Files\Docsvision\Database\WindowsClient\WindowsClientCardLib.xml`.
* `C:\Program Files\Docsvision\Database\Workflow\WorkflowCardLib.xml`.
* `C:\Program Files\Docsvision\Database\WorkerService\WorkerServiceCardLib.xml`.

Здесь `C:\Program Files\Docsvision\` -- каталог установки сервера {dv}.
****
+
.Расположение библиотек карточек в Linux:
****
* `/usr/lib/docsvision/database/ApprovalDesigner/ApprovalDesignerCardLib.xml`.
* `/usr/lib/docsvision/database/BackOffice/BackOfficeCardLib.xml`.
* `/usr/lib/docsvision/database/Core/SystemCardLib.xml`.
* `/usr/lib/docsvision/database/DocumentManagement/DocumentManagementCardLib.xml`.
* `/usr/lib/docsvision/database/TakeOffice/TakeOfficeCardLib.xml`.
* `/usr/lib/docsvision/database/WindowsClient/WindowsClientCardLib.xml`.
* `/usr/lib/docsvision/database/Workflow/WorkflowCardLib.xml`.
* `/usr/lib/docsvision/database/WorkerService/WorkerServiceCardLib.xml`.
+
Здесь `/usr/lib/docsvision/database/` -- каталог установки сервера {dv}.
****
+
